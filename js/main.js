const TELEGRAM_USERNAME = 'garun_web'
...
const isTelegramConfigured =
	!TELEGRAM_USERNAME.includes('[') &&
	!TELEGRAM_USERNAME.includes(']') &&
	TELEGRAM_USERNAME.trim().length > 0
const TELEGRAM_DIRECT_URL = isTelegramConfigured
...
const cases = [
	{
		id: 'velora',
		title: 'VELORA — кухни и встроенная мебель на заказ',
		shortTitle: 'VELORA',
		url: 'https://velora88.vercel.app/',
		image: 'cases-img/velora.png',
		niche: 'Кухни и мебель / премиальный интерьерный бренд',
		cardText:
			'Создать премиальный многостраничный сайт для бренда индивидуальных кухонь и встроенной мебели, который показывает характер коллекций, инженерную продуманность и ведёт клиента к дизайн-встрече.',
		result:
			'Получился цельный сайт бренда, где кухня раскрывается как часть архитектуры дома: от коллекций и материалов до хранения, производства, монтажа и предварительного расчёта проекта.',
		cta: 'Хочу сайт для мебельного бренда',
		done: [
			'Собрана выразительная hero-подача с крупной типографикой, сменой интерьерных сцен и двумя понятными CTA',
			'Разработаны страницы кухонь, коллекций Lento, Nero и Pura, встроенной мебели и материалов',
			'Показаны инженерные схемы, внутреннее хранение, материалы, мастерская и путь от проекта до монтажа',
			'Добавлена форма дизайн-встречи с типом проекта, контактом и предварительным запросом',
		],
		features: [
		...
		blocks: [
			...
			'Коллекции Lento / Nero / Pura',
			'Инженерия и хранение',
			'Мебель для всего интерьера',
			'Материалы',
	...
	},
	{
		...
		cardText:
			'Создать лендинг для строительной компании, который объясняет условия строительства под ключ, фиксированную цену, этапы работы и помогает получить заявку на расчёт дома.',
		result:
			'Получился лендинг для дорогой услуги, где пользователь видит обещание, понимает процесс, получает ценовые ориентиры и может отправить заявку на расчёт.',
	...
	{
		id: 'forma-remonta',
		title: 'Forma ремонта — комплексный ремонт квартир под ключ',
		shortTitle: 'Forma ремонта',
		url: 'https://forma-remonta.vercel.app/',
		image: 'cases-img/forma-remonta.png',
		niche: 'Ремонт квартир / Москва и область / услуга с высоким чеком',
		cardText:
			'Создать убедительный лендинг для компании по комплексному ремонту квартир, который показывает прозрачную смету, этапы и контроль качества и помогает получить заявку на предварительный расчёт.',
		result:
			'Получился подробный лендинг для услуги с высоким чеком: премиальная визуальная подача поддерживает доверие, а портфолио, расчёт бюджета и прозрачный процесс последовательно ведут пользователя к заявке.',
		cta: 'Хочу лендинг для ремонта',
		done: [
			'Разработаны позиционирование, структура и спокойная премиальная визуальная система',
			'Собраны блоки направлений ремонта, портфолио, стоимости, процесса, команды, гарантий и FAQ',
			'Добавлены интерактивное сравнение «до/после» и семишаговый квиз с ориентиром по бюджету',
			'Настроены адаптивные формы с валидацией и передачей заявок через серверную функцию Vercel',
		],
		features: [
			'7-шаговый квиз',
			'Сравнение «до/после»',
	...
	},
	{
		...
		niche: 'Регистрация в Москве и МО / документы и маршрут оформления',
		cardText:
			'Обновить сайт консультационной услуги и помочь посетителю начать с описания ситуации, выбрать подходящий сценарий и понять, какие документы и действия потребуется проверить.',
		result:
			'Редизайн выстраивает маршрут от первого обращения до следующего шага: посетитель выбирает сценарий, знакомится с вариантами регистрации, документами и этапами, а затем отправляет обращение с нужными параметрами.',
		cta: 'Хочу сайт с понятным маршрутом',
		done: [
			'Полностью обновлён первый экран: сформулирована польза и показан маршрут обращения в три шага',
			'Добавлены сценарии для личного обращения, семьи и работодателя или HR',
			'Собраны разделы о временной и постоянной регистрации, документах, стоимости и отдельном маршруте для иностранных граждан',
			'Форма передаёт сценарий и тип регистрации, контакт, канал ответа и согласие на обработку данных',
		],
		features: [
			'Сценарии для разных ситуаций',
			'Интерактивный маршрут обращения',
			'Проверка документов и стоимости',
			'Форма с выбором канала ответа',
		],
		blocks: [
			'Первый экран',
			'Сценарии обращения',
			...
			'Документы',
			'Стоимость',
			'Отдельный маршрут для иностранных граждан',
			'FAQ',
			'Форма обращения',
		],
		functionality: [
			...
			'Переключаемые этапы обращения',
			'Форма с параметрами ситуации',
	...
	},
	{
		...
		cardText:
			'Создать спокойный лендинг для продукта, где важно передать натуральность, понятное происхождение, доверие к процессу и перевести заказ в Telegram без лишних форм.',
		result:
			'Получилась посадочная страница для продукта, которая не давит продажей, а через спокойные аргументы переводит пользователя к заказу в Telegram.',
	...
	},
	{
		...
		cardText:
			'Собрать лендинг для услуги с быстрым монтажом, понятной ценой за м², калькулятором, примерами работ и заявкой на бесплатный замер.',
		result:
			'Лендинг показывает услугу визуально и даёт пользователю быстрый способ оценить бюджет до консультации.',
	...
	},
	{
		...
		cardText:
			'Готовый лендинг для салона красоты: первый экран объясняет услуги, расположение, преимущества записи и ведёт пользователя к заявке или сообщению в мессенджер.',
		result:
			'Лендинг аккуратно презентует услуги салона, показывает понятные CTA и помогает перейти к записи без лишних шагов.',
	...
	},
	{
		...
		cardText:
			'Готовый лендинг для услуги с доставкой и установкой бань: первый экран показывает предложение, ключевые условия, CTA на расчёт стоимости и получение каталога.',
		result:
			'Лендинг помогает быстро понять формат услуги, увидеть основные преимущества и перейти к расчёту или заявке.',
	...
	{
		id: 'razor-premium',
		title: 'RAZOR / 01 — предметный лендинг для опасной бритвы',
		shortTitle: 'RAZOR / 01',
		url: 'https://razor-premium.vercel.app/',
		image: 'cases-img/razor-premium.png',
		niche: 'Авторский предмет / handmade / премиальный продукт',
		cardText:
			'Дать одному редкому предмету достаточно пространства на странице. Передать фактуру материалов, объяснить конструкцию и спокойно довести пользователя до запроса стоимости.',
		result:
			'Получился спокойный предметный лендинг с крупной типографикой и паузами. Сначала внимание держится на самой бритве, затем страница раскрывает материалы, механику, размеры и способ связаться с мастером.',
		cta: 'Хочу лендинг для авторского продукта',
		done: [
			'Собрана атмосферная подача с крупным первым экраном и акцентом на самом предмете',
			'Через отдельные секции показаны рог, сталь, медь, латунь и механика складной конструкции',
			'Добавлены размеры, сценарии использования, история изделия и блок с запросом стоимости',
			'Форма заявки оставлена короткой: имя, телефон и вопрос без длинного квиза',
		],
		features: [
			'Предметная подача',
			'Материалы и детали',
...
const formatRub = value =>
	new Intl.NumberFormat('ru-RU').format(Math.round(value / 1000) * 1000)
...
function renderLeadContext() {
	...
	const title = entries.length
		? 'Заявка по выбранному формату'
		: 'Можно оставить заявку сразу'
...
function initHeader() {
	...
	const stickyContexts = [
		[
			'#cases',
			{ href: '#lead', text: 'Хочу похожий лендинг', cta: 'sticky_cases' },
		],
		[
			'#pricing',
			{ href: '#lead', text: 'Обсудить тариф', cta: 'sticky_pricing' },
		],
		[
			'#calculator',
			{
		...
		[
			...
			{
				href: '#mini-audit',
				text: 'Подобрать формат',
				cta: 'sticky_start_guide',
			},
		],
	]
	...
	const syncHeader = () => {
		...
		if (stickyCta && hero) {
			...
			const shouldShow =
				window.scrollY > hero.offsetHeight - 160 &&
				!isInAvoidArea &&
    ...
    <article class="case-card" aria-labelledby="case-title-${item.id}">
      ...
      <div class="case-card__body">
        ...
        <ul class="case-card__features" aria-label="Функциональность кейса">
          ${(item.functionality || item.features)
						.slice(0, 4)
...
function initRevealAnimations() {
	...
	revealGroups.forEach(group => {
		const items = qsa(itemSelector, group).filter(
			item => item.offsetParent !== null && !item.closest('.modal'),
		)
...
function renderCalculator() {
	...
	next.textContent =
		calcState.step === calculatorSteps.length - 1 ? 'Показать расчёт' : 'Далее'
    ...
    `
		...
		const current =
			calcState.answers[step.key] || (step.type === 'checkbox' ? [] : '')
		container.innerHTML = `
      <h3>${step.title}</h3>
...
function renderCalcSummary() {
	...
	summary.innerHTML = lines.length
		? lines.join('')
		: '<span>Выбранные параметры появятся здесь.</span>'
}
...
function saveCurrentStep() {
	...
	if (step.type === 'contact') {
		calcState.answers.calc_name =
			qs('[name="calc_name"]', form)?.value.trim() || ''
		calcState.answers.calc_contact =
			qs('[name="calc_contact"]', form)?.value.trim() || ''
		calcState.answers.calc_comment =
			qs('[name="calc_comment"]', form)?.value.trim() || ''
		calcState.answers.calc_consent = Boolean(
			qs('[name="calc_consent"]', form)?.checked,
		)
		return
	}
	const checked = qsa(`[name="${step.key}"]:checked`, form).map(
		input => input.value,
	)
	calcState.answers[step.key] =
		step.type === 'checkbox' ? checked : checked[0] || ''
}
...
function validateCurrentStep() {
	...
	if (step.type === 'contact') {
		...
		if (!calcState.answers.calc_consent) {
			error.textContent =
				'Подтвердите согласие с политикой, чтобы отправить расчёт.'
			return false
		}
...
function calculateEstimate() {
	...
	const base =
		{ new: 52000, figma: 32000, repair: 22000, interactive: 18000 }[a.task] ||
		42000
	const blockAdd =
		{ up5: 0, '6-8': 11000, '9-12': 23000, '12+': 38000, unknown: 15000 }[
			a.blocks
		] || 0
	const designAdd =
		{ figma: 0, simple: 15000, custom: 32000, 'only-code': 0 }[a.design] || 0
	...
	const contentAdd =
		{ ready: 0, structure: 9000, texts: 12000, materials: 16000 }[a.content] ||
		0
	const urgency = a.deadline === 'fast' ? 1.2 : 1
	const low =
		(base + blockAdd + designAdd + featureAdd + contentAdd) *
		urgency *
		ESTIMATE_DISCOUNT
	const high = low * 1.28
	const tariff =
		high < TARIFF_THRESHOLDS.startMax
			? 'Старт'
			: high < TARIFF_THRESHOLDS.standardMax
				? 'Бизнес'
				: 'Продажи+'
	const includes =
		tariff === 'Старт'
...
function initFaq() {
	qsa('.faq-item button').forEach(button => {
		button.addEventListener('click', () => {
			...
			qsa('.faq-item button').forEach(other =>
...
function initForms() {
	qsa('[data-lead-form]').forEach(form => {
		...
		form.addEventListener('submit', async event => {
			...
			qsa('[aria-invalid="true"]', form).forEach(field =>
			...
			try {
				...
				if (result.demo) {
					status.textContent =
						'Демо-режим: заявка сформирована. На Vercel заявки будут уходить через /api/send-lead в Telegram-бот.'
				} else {
					status.textContent =
						form.dataset.formType === 'Мини-аудит'
...
function hydrateHiddenFields() {
	const url = new URL(window.location.href)
	qsa('[name="current_url"]').forEach(field => {
		field.value = window.location.href
	})
	qsa('[name="referrer"]').forEach(field => {
		field.value = document.referrer
	})
	;['utm_source', 'utm_medium', 'utm_campaign'].forEach(key => {
		qsa(`[name="${key}"]`).forEach(field => {
			field.value = url.searchParams.get(key) || ''
		})
	})
	qsa('[name="timestamp"]').forEach(field => {
