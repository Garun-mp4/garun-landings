...
const cases = [
	...
	},
	{
		...
		cardText:
			'Сделать понятную посадочную страницу для услуги, где клиенту важно быстро разобраться в типах регистрации, документах, стоимости и способе связи.',
		result:
			'Лендинг снижает юридическую путаницу: объясняет услугу простым языком, помогает выбрать сценарий и переводит пользователя к консультации.',
